...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <section class="dark" id="get-involved">
      <div class="container">
        <div class="row">
          <h2>Hvordan kommer jeg med?</h2>
          <div class="col-md-4">
            <div class="circ"><p>1.</p></div>
            <h3>FORTÆL OM DIN VIDEO IDÉ</h3>
            <p>På under 500 tegn skal du fortælle os, om de sjove eller vanvittige ting, du vil gøre, mens du hører tracket.</p>

          </div>
          <div class="col-md-4">
            <div class="circ"><p>2.</p></div>
            <h3>OPTAG DIN 360&deg; SCENE</h3>
          ...
          <div class="col-md-4">
            ...
            <h3>SEND OS DIT KLIP</h3>
            <p>Det bedste 360° videomateriale, vi modtager, bliver klippet ind i videoen og vist over hele verden. Fedt, ikke?</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          ...
          <form method="post" id="nightingale-form">
            ...
            <div class="col-md-12">
                ...
                <input type="submit" name="submit" value="VI GØR DET!">
            </div>
          </form>
        </div>
      </div>
    ...
    <section class="light" id="terms">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <p>Du skal være fyldt 18 år for at indsende materiale. Når du indsender materiale via denne side, så giver du samtidig Libratone og Libratones moder- og datterselskaber de fulde rettigheder til, uden betingelser, at opbevare, redigere, oversætte, distribuere og publicere materialet over hele verden i de mediakanaler og på de platforme, som Libratone ønsker.</p>
          </div>
        </div>
      </div>
    </section>
